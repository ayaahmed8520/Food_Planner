...
import com.example.foodplanner.view.SpecificArea.SpecificAreaMeal;
import com.example.foodplanner.model.SearchResponse;
...
public class AllCountry extends AppCompatActivity implements AllCountryInterface {
    ...
    public List<Country> getCountries() {
        return new SearchResponse().getAreas();
    }
