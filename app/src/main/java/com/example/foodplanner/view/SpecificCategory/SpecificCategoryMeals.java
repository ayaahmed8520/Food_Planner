...
import com.example.foodplanner.presenter.SpecificCategoryMealsPresenter;
...
public class SpecificCategoryMeals extends AppCompatActivity implements SpecificCategoryMealsInterface {
    ...
    SpecificCategoryMealsPresenter specificCategoryMealsPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        specificCategoryMealsPresenter = new SpecificCategoryMealsPresenter(this);
    ...
    public void getSpecificCategoryMeals(String categoryName) {
        specificCategoryMealsPresenter.getSpecificCategoryMeal(categoryName);
    }
