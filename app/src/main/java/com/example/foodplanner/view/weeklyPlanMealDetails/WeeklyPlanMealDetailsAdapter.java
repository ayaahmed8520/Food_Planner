...
import com.example.foodplanner.view.weekPlan.AddAndRemoveFromPlan;
...
public class WeeklyPlanMealDetailsAdapter extends RecyclerView.Adapter<WeeklyPlanMealDetailsAdapter.Holder> {
    ...
    private final List<WeeklyPlanMealDetails> weeklyPlanMealDetailsArrayList;
    ...
    public WeeklyPlanMealDetailsAdapter(List<WeeklyPlanMealDetails> mealDetailsArrayList) {
    ...
    public void onBindViewHolder(@NonNull WeeklyPlanMealDetailsAdapter.Holder holder, int position) {
        ...
        String clientID = InFirebaseImp.getInstance(holder.black_background.getContext()).getSharedPreferences().getString("clientID", null);
